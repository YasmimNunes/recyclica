    ...
    public class RoleApprovalController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var pendingApprovals = await _dbContext.UserRolesApproval
                ...
                {
                    Id = x.Id,
                    UserName = x.User != null ? (_dbContext.Entry(x.User).Property<string>("FullName").CurrentValue) ?? "Unknown User" : "Unknown User",
                    Email = x.User != null ? x.User.UserName ?? "Unknown User" : "Unknown User",
            ...
            var users = await _userManager.Users
                ...
                {
                    Id = user.Id,
                    UserName = _dbContext.Entry(user).Property<string>("FullName").CurrentValue,
                    Email = user.Email,
        ...
        [Authorize(Roles = "Gerente de operações")]
        ...
        public async Task<IActionResult> Editar(UserViewModel model)
        {
            ...
            // Mensagem de sucesso após editar
        ...
        public async Task<IActionResult> Approve(int id)
        {
            ...
            TempData["SuccessMessage"] = "Usuário aprovado com sucesso!";
        ...
        public async Task<IActionResult> Reject(int id)
        {
            ...
            // Mensagem de sucesso após a rejeição
            TempData["SuccessMessage"] = "Usuário rejeitado e removido com sucesso!";
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            // Adicionar a mensagem de sucesso ao TempData
