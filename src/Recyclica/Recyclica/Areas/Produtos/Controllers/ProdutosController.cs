    ...
    public class ProdutosController : Controller
    {
        ...
        public IActionResult RegistrarVenda(int produtoId, int clienteId, string nomeProduto, string tipo, double peso, DateTime? dataEntrada)
        {
            ...
            var relatorioProduto = new RelatorioProdutos
            {
                ...
                Cliente = $"{cliente.Nome} ({cliente.CNPJ_CPF})" // Usa o nome e CNPJ_CPF do cliente recuperado
            };
            ...
            // Armazena a mensagem de sucesso em TempData
            TempData["SuccessMessage"] = "Produto vendido com sucesso!";
        ...
        public IActionResult Deletar(int id)
        {
            ...
            if (produto == null)
            {
                // Se o produto não for encontrado, mostra um erro
                TempData["ErrorMessage"] = "Produto não encontrado.";
                return RedirectToAction("Index");
            }

            // Retorna a view de confirmação de deletação
            return View(produto);
        }
        ...
        public IActionResult ConfirmarDeletar(int id)
        {
            ...
            if (produto != null)
            {
                ...
                // Redireciona para a página de índice com a lista de produtos
                return RedirectToAction("Index");
            }

            // Se o produto não for encontrado, armazena a mensagem de erro
            TempData["ErrorMessage"] = "Produto não encontrado.";
            return RedirectToAction("Index");
        }
        ...
        {
            IEnumerable<RelatorioProdutos> relatorioProdutos = _db.RelatorioProdutos;
